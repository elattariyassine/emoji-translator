...
export default function EmojiModal({ isOpen, onClose }: EmojiModalProps) {
  ...
  return (
    <>
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200"
                autoFocus
              />
              <svg
      ...
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-6 py-3 rounded-full shadow-lg z-50 animate-fade-in-up">
          {toastMessage}
        </div>
      )}
    </>
